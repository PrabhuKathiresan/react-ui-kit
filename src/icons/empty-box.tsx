...
export default function EmptyBox({ headerHeight = 0, footerHeight = 0, emptyText = 'No data found' }) {
  return (
    <div className='ui-table-empty d-flex-justify-center-align-center' style={{ top: headerHeight, bottom: footerHeight }}>
      <svg width="64" height="41" viewBox="0 0 64 41" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(0 1)" fill="none" fillRule="evenodd">
          <ellipse fill="#f5f5f5" cx="32" cy="33" rx="32" ry="7" />
          <g stroke="#cfd7df" fillRule="nonzero">
